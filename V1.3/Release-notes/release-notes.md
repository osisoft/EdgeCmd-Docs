...
For more information, see [EdgeCmd utility](xref:index1-3).

## Fixes and enhancements

### Fixes

The command line syntax and processing of EdgeCmd utility v1-3 has been entirely reworked from scratch, so there are no specific fixes.
...
Refer to [System requirements](xref:SystemRequirements1-3).

## Installation and upgrade

Refer to [Install EdgeCmd utility](xref:InstallEdgeCmdUtility1-3).

## Uninstallation

Refer to [Uninstall EdgeCmd utility](xref:UninstallEdgeCmdUtility1-3).
